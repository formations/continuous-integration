...
. Télécharger l'https://jenkins.io/download/[archive] en fonction du système d'exploitation
...
. Ajouter le chemin de vers le répertoire d'installation de Jenkins à la variable d'environnement `PATH`
