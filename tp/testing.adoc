...
En français: ::
+
* https://blog.octo.com/la-pyramide-des-tests-par-la-pratique-1-5/[La pyramide des tests par la pratique (1/5)^]
...
. Ajouter la dernière version de TestNG comme dépendance Maven de test au projet.
. Implémenter les tests dans le répertoire Maven adapté.
